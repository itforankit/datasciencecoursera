...
```{r data_Ex_Analysis_2, echo=TRUE}
betahat <- .7245  
SE <- 1.764        
...
```{r data_Mult_Var_Ana_1, echo=TRUE}
library(MASS)
...
```{r data_Signifacance_1, echo=TRUE}
